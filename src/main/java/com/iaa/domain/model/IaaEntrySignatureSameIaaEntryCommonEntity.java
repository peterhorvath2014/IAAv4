 ...
 */
@Entity
@Table(name = "iaa_entry_signature_same_iaa_entry_common", schema = "iaa", catalog = "")
public class IaaEntrySignatureSameIaaEntryCommonEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        IaaEntrySignatureSameIaaEntryCommonEntity that = (IaaEntrySignatureSameIaaEntryCommonEntity) o;
