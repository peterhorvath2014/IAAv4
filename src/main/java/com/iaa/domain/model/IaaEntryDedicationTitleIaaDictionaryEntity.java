 ...
 */
@Entity
@Table(name = "iaa_entry_dedication_title_iaa_dictionary", schema = "iaa", catalog = "")
public class IaaEntryDedicationTitleIaaDictionaryEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        IaaEntryDedicationTitleIaaDictionaryEntity that = (IaaEntryDedicationTitleIaaDictionaryEntity) o;
