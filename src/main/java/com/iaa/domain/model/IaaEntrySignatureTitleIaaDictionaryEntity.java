 ...
 */
@Entity
@Table(name = "iaa_entry_signature_title_iaa_dictionary", schema = "iaa", catalog = "")
public class IaaEntrySignatureTitleIaaDictionaryEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        IaaEntrySignatureTitleIaaDictionaryEntity that = (IaaEntrySignatureTitleIaaDictionaryEntity) o;
