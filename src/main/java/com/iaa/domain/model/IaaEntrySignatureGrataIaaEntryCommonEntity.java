 ...
 */
@Entity
@Table(name = "iaa_entry_signature_grata_iaa_entry_common", schema = "iaa", catalog = "")
public class IaaEntrySignatureGrataIaaEntryCommonEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        IaaEntrySignatureGrataIaaEntryCommonEntity that = (IaaEntrySignatureGrataIaaEntryCommonEntity) o;
